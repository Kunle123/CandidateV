...
- Name: Signup Flow >> should show error for terms not accepted
- Location: /Users/admin/Documents/KunleDevFolder/CandidateV/frontend/e2e/signup.spec.ts:90:3
...
Locator: locator('form').getByRole('group').filter({ has: locator('#auth-terms') })
Expected string: "true"
Received string: ""
Call log:
  - expect.toHaveAttribute with timeout 10000ms
  - waiting for locator('form').getByRole('group').filter({ has: locator('#auth-terms') })
    13 × locator resolved to <div role="group" data-invalid="" class="chakra-form-control css-1kxonj9">…</div>
       - unexpected value "null"

    at /Users/admin/Documents/KunleDevFolder/CandidateV/frontend/e2e/signup.spec.ts:105:36
```
...
- group:
  - text: Email
  - textbox "Email": testuser1745348421259@example.com
- group:
  - text: Password
...
- group:
  ...
  - text: I accept the terms and conditions You must accept the terms and conditions
- button "Sign Up"
- paragraph:
