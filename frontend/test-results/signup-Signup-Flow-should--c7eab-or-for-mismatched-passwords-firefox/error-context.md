...
- Name: Signup Flow >> should show error for mismatched passwords
- Location: /Users/admin/Documents/KunleDevFolder/CandidateV/frontend/e2e/signup.spec.ts:69:3
...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div class="css-1jgfjfb">…</div> intercepts pointer events
    ...
    at /Users/admin/Documents/KunleDevFolder/CandidateV/frontend/e2e/signup.spec.ts:77:51
```
...
- group:
  - text: Email
  - textbox "Email": testuser1745348419920@example.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Confirm Password": DifferentPassword123!
  - button "Show password"
- group:
