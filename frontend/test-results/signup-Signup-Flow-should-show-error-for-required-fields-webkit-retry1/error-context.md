...
- Name: Signup Flow >> should show error for required fields
- Location: /Users/admin/Documents/KunleDevFolder/CandidateV/frontend/e2e/signup.spec.ts:112:3
...
Locator: locator('form').getByRole('group').first()
Expected string: "true"
Received string: ""
Call log:
  - expect.toHaveAttribute with timeout 10000ms
  - waiting for locator('form').getByRole('group').first()
    13 × locator resolved to <div role="group" data-invalid="" class="chakra-form-control css-1kxonj9">…</div>
       - unexpected value "null"

    at /Users/admin/Documents/KunleDevFolder/CandidateV/frontend/e2e/signup.spec.ts:117:40
```
